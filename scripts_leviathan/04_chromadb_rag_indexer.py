...
def local_chroma_rag_inject():
    ...
    # Ordenar archivos para procesamiento determinista
    for i, archivo in enumerate(sorted(archivos), 1):
        ...
        try:
            ...
            # This avoids splitting the entire string if it's large, which is ~140x faster.
    ...
    # Inyectar el último lote si quedó algo
    flush_batch()
