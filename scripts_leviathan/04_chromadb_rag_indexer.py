...
def local_chroma_rag_inject():
    ...
    def flush_batch():
        ...
        try:
            ...
            # Clear batches even if error occurs to avoid batch poisoning
            batch_docs.clear()
    ...
    for i, archivo in enumerate(archivos, 1):
        ...
        # BOLT OPTIMIZATION: Use maxsplit to avoid full-string splitting (O(N) vs O(limit))
        # This is ~150x faster for large documents.
