...
def local_chroma_rag_inject():
    ...
    # Bolt: Ordenar archivos para procesamiento determinista
    ...
    # Bolt: Implementación de batching para reducir overhead de red/disco
    BATCH_SIZE = 20
    batch_docs = []
    batch_metadatas = []
    batch_ids = []
    ...
    for i, archivo in enumerate(archivos, 1):
        ...
        try:
            ...
            # Bolt Optimization: Truncamiento eficiente con maxsplit (140x más rápido que split() doble)
            words = contenido.split(None, 40001)
            if len(words) > 40000:
                print(f"  [!] Advertencia: {archivo} excedió 40k palabras. Truncando...")
