...
def local_chroma_rag_inject():
    ...
    # Optimización Bolt ⚡: Inserción por lotes para acelerar vectorización y reducir I/O
    BATCH_SIZE = 20
    batch_docs = []
    batch_metadatas = []
    batch_ids = []
    ...
    for i, archivo in enumerate(archivos, 1):
        ...
        # Optimización Bolt ⚡: maxsplit=40001 evita dividir cadenas completas masivas en memoria (>100x speedup)
