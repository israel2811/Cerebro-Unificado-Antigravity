...
def local_chroma_rag_inject():
    ...
    for i, archivo in enumerate(archivos, 1):
        ...
        # BOLT OPTIMIZATION: Using split(None, 40001) is significantly faster than a full split()
        # because it stops parsing the string as soon as the limit is reached, avoiding
        # unnecessary memory allocation and processing for massive files.
