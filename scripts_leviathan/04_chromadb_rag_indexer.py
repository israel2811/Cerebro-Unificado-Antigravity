...
BATCH_SIZE = 50 # ⚡ BOLT: Reducción de latencia por procesamiento en lotes
...
def local_chroma_rag_inject():
    ...
    for i, archivo in enumerate(archivos, 1):
        ...
        try:
            ...
            # ⚡ BOLT: Optimización de procesamiento de strings.
            # Heurística: si tiene menos de 40k caracteres, tiene menos de 40k palabras.
            # Evitamos .split() innecesario para archivos pequeños.
            if len(contenido) > 40000:
                # Usamos maxsplit para no procesar todo el archivo si ya llegamos al límite.
                palabras = contenido.split(None, 40000)
