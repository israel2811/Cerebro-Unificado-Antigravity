...
def local_chroma_rag_inject():
    ...
    # Optimización Bolt: Procesamiento por lotes (batching) para reducir overhead de transacciones
    BATCH_SIZE = 20
    batch_docs = []
    batch_metadatas = []
    batch_ids = []
    ...
    for i, archivo in enumerate(archivos, 1):
        ...
        try:
            ...
            # Optimización Bolt: Usar maxsplit=40001 para evitar el costo O(N) de splitear
            # todo el documento si este supera con creces el límite.
