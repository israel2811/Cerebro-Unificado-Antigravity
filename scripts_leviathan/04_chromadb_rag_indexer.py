...
# ⚡ BOLT OPTIMIZATION: Batch size for database efficiency
BATCH_SIZE = 50
...
def local_chroma_rag_inject():
    ...
    # ⚡ BOLT OPTIMIZATION: Use batches to reduce overhead and improve embedding speed
    batch_docs = []
    batch_metadatas = []
    batch_ids = []
    ...
    def flush_batch():
        ...
        try:
            ...
            # Clear batches regardless of success to prevent "poisoned batches"
            batch_docs.clear()
    ...
    for i, archivo in enumerate(archivos, 1):
        ...
        try:
            ...
            # ⚡ BOLT OPTIMIZATION:
            # 1. Use char-length heuristic (40k chars) before split() to avoid overhead on small docs.
            # 2. Use maxsplit=40001 to avoid scanning the whole buffer if it's huge.
