...
def local_chroma_rag_inject():
    ...
    # Optimización Bolt: Implementar batching para reducir overhead de llamadas a DB/API
    BATCH_SIZE = 20
    batch_docs = []
    batch_metadatas = []
    batch_ids = []
    ...
    for i, archivo in enumerate(archivos, 1):
        ...
        try:
            ...
            # Optimización Bolt: Usar maxsplit para evitar tokenizar todo el archivo si es muy grande
