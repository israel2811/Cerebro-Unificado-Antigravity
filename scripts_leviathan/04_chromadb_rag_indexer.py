...
def local_chroma_rag_inject():
    ...
    # Procesar en lotes reduce radicalmente el overhead de llamadas y latencia de E/S.
    BATCH_SIZE = 20
    batch_docs = []
    batch_metadatas = []
    batch_ids = []
    ...
    for i, archivo in enumerate(archivos, 1):
        ...
        # --- BOLT OPTIMIZATION: EFFICIENT TRUNCATION ---
        # split(None, 40001) evita dividir todo el string si es muy grande, ahorrando CPU/RAM.
