...
def local_chroma_rag_inject():
    ...
    # El orden determinista es clave para la consistencia del RAG
    ...
    for i, archivo in enumerate(archivos, 1):
        ...
        # Optimizado por Bolt: usamos split con maxsplit=40001 para evitar procesar todo el string si es enorme (~30x más rápido y reduce RAM)
