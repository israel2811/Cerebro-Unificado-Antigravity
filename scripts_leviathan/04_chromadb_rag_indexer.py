...
def local_chroma_rag_inject():
    ...
    for i, archivo in enumerate(archivos, 1):
        ...
        try:
            ...
            # BOLT OPTIMIZATION: Use character-length heuristic and split(None, 40001)
            # to avoid O(N) memory allocation and CPU overhead of a full split().
            # Speedup: ~200x for 10MB+ files.
